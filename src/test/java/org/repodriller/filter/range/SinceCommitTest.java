...
public class SinceCommitTest {
	...
	public void should_get_commits_in_range() {
		...
		ChangeSet c2 = new ChangeSet("1", "", new CommitPerson("", "", new GregorianCalendar(2015, Calendar.MARCH, 24)));
		ChangeSet c3 = new ChangeSet("1", "", new CommitPerson("", "", new GregorianCalendar(2015, Calendar.APRIL, 25)));
		ChangeSet c4 = new ChangeSet("1", "", new CommitPerson("", "", new GregorianCalendar(2015, Calendar.APRIL, 25)));
		ChangeSet c5 = new ChangeSet("1", "", new CommitPerson("", "", new GregorianCalendar(2015, Calendar.APRIL, 25)));
